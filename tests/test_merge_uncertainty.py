...
class TestDefaultScorerWithUncertainty:
    ...
    def test_high_conf_boosts_score(self) -> None:
    ...
    def test_no_uncertainty_no_penalty(self) -> None:
    ...
    def test_zero_uncertainty_score(self) -> None:
