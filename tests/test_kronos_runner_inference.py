...
class TestKronosRunnerPredictOneErrorPaths:
    ...
    def test_cache_hit_restores_uncertainty(self) -> None:
    ...
    def test_prepare_data_too_short(self) -> None:
        """数据不足时应设置 error 字段。"""
        from trade_krono_cli.kronos_runner import KronosRunner
    ...
    def test_predictor_error_sets_result_error(self) -> None:
        """预测器抛异常时应捕获并记录。"""
        from trade_krono_cli.kronos_runner import KronosRunner
...
class TestKronosRunnerPredictBatch:
    ...
    def test_batch_fallback_to_single_on_failure(self) -> None:
        """批量预测失败时应降级为逐只预测。"""
        from trade_krono_cli.kronos_runner import KronosRunner
    ...
    def test_batch_all_prepare_fails(self) -> None:
        """所有股票数据准备失败时返回空结果。"""
        from trade_krono_cli.kronos_runner import KronosRunner
...
class TestKronosBatchInference:
    ...
    def test_batch_size_from_settings(self) -> None:
    ...
    def test_pad_df_shorter_than_target(self) -> None:
    ...
    def test_pad_df_longer_than_target(self) -> None:
    ...
    def test_pad_df_exact_length(self) -> None:
        """长度相同时不做修改。"""
        from trade_krono_cli.kronos_runner import KronosRunner
    ...
    def test_split_batches_basic(self) -> None:
        """基本分批逻辑。"""
        from trade_krono_cli.kronos_runner import KronosRunner
    ...
    def test_predict_batch_sends_single_batch_when_within_limit(self) -> None:
    ...
    def test_predict_batch_single_batch_success(self) -> None:
        """单批成功时直接返回结果。"""
        from trade_krono_cli.kronos_runner import KronosRunner
    ...
    def test_predict_batch_handles_all_cached(self) -> None:
        """全部缓存命中时直接返回，不调用模型。"""
        from trade_krono_cli.kronos_runner import KronosRunner
