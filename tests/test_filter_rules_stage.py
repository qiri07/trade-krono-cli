...
class TestFilterRulesStage:
    ...
    def test_none_rules_init(self) -> None:
    ...
    def test_not_in_rule(self) -> None:
    ...
    def test_field_alias_market_cap_billion(self) -> None:
    ...
    def test_field_alias_pe_ttm(self) -> None:
