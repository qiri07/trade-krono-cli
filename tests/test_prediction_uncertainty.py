...
def test_prediction_uncertainty_is_alias() -> None:
...
def test_build_uncertainty_alias() -> None:
...
def test_use_as_prediction_distribution() -> None:
    """可以通过别名创建实例并调用方法。"""
