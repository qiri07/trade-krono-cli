...
class TestFetchStockQuote:
    ...
    def test_returns_quote_dict(self) -> None:
    ...
    def test_returns_empty_dict_on_empty_quote(self) -> None:
...
class TestPrepareKlineBatch:
    ...
    def test_failed_ticker_skipped(self) -> None:
        """单只股票失败不应中断其他股票的处理。"""
    ...
    def test_generic_exception_skipped(self) -> None:
    ...
    def test_custom_parameters_passed_through(self) -> None:
