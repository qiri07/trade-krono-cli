...
class TestGetCachedDateRange:
    ...
    def test_empty_returns_none(self, tmp_path) -> None:
    ...
    def test_with_single_entry(self, tmp_path) -> None:
        from trade_krono_cli.cache import Cache
    ...
    def test_with_multiple_segments(self, tmp_path) -> None:
    ...
    def test_expired_ttl_returns_none(self, tmp_path) -> None:
        """TTL 已过期时应视为无缓存。"""
        import time
    ...
    def test_mixed_ttl_some_expired(self, tmp_path) -> None:
        """部分条目过期时，只统计有效条目。"""
        import time
    ...
    def test_different_ticker_returns_none(self, tmp_path) -> None:
        from trade_krono_cli.cache import Cache
...
class TestMergeKlineDfs:
    ...
    def test_new_extends_old(self) -> None:
        """新数据在旧数据之后（无重叠）→ 拼接。"""
    ...
    def test_new_completely_inside_old(self) -> None:
    ...
    def test_duplicate_timestamps_kept_last(self) -> None:
...
class TestFetchKlineIncremental:
    ...
    def test_no_cache_full_fetch(self, tmp_path) -> None:
    ...
    def test_full_cache_coverage(self, tmp_path) -> None:
        """缓存已完整覆盖请求范围 → 不发起网络请求。"""
        from trade_krono_cli.cache import Cache
        from trade_krono_cli.data import fetch_kline_incremental
    ...
    def test_partial_cache_gap_fetch(self, tmp_path) -> None:
    ...
    def test_expired_cache_triggers_full_fetch(self, tmp_path) -> None:
    ...
    def test_use_cache_false_bypasses_cache(self, tmp_path) -> None:
