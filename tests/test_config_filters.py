...
class TestFilterConfig:
    ...
    def test_merge_overrides_min_confidence(self) -> None:
    ...
    def test_merge_empty_no_change(self) -> None:
        cfg = FilterConfig(min_confidence=70.0)
        merged = cfg.merge()
        assert merged.min_confidence == 70.0

    def test_merge_with_filter_rules(self) -> None:
    ...
    def test_merge_updates_filter_rules(self) -> None:
    ...
    def test_validate_multiple_valid_signals(self) -> None:
        cfg = FilterConfig(allowed_signals=("BUY", "HOLD", "SELL"))
        errors = cfg.validate()
        assert errors == []

    def test_merge_with_range_configs(self) -> None:
